...
const Header = () => {
  ...
  return (
    <div
      id="header"
      className="fixed z-50 top-0 right-0 left-0 bg-white px-4 py-8 2xl:px-14 container w-full max-w-full mx-auto text-primary-color"
    >
      <div className="flex justify-between items-center flex-row">
        ...
        <div className="hidden lg:flex">
          ...
          <a href='https://github.com/qthwng01' target='_blank' className="bg-primary-color text-white font-medium text-xl rounded-2xl px-7 py-2">
            Hire me
          </a>
        </div>
